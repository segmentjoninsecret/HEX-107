...
class Args:
    ...
    pretrained_path: str = "./pretrained_models/hex/libero_all_2B/hex_ac100_2w_8gpu_state_query_history0_ft/final_model/pytorch_model.pt"

    post_process_action: bool = True

    job_name: str = "test"

    log_path: str = "./pretrained_models/hex/libero_all_2B/hex_ac100_2w_8gpu_state_query_history0_ft/final_model"
...
def eval_libero(args: Args) -> None:
    ...
    name = Path(args.pretrained_path).stem
    log_file = open(f"{args.log_path}/libero_eval_{args.task_suite_name}_{name}.log", "w")
